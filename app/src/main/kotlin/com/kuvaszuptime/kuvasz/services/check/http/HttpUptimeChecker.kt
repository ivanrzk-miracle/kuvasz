...
class HttpCheckerClientConfiguration(config: ApplicationConfiguration) : HttpClientConfiguration(config) {
    ...
    override fun getSslContext(): Optional<SSLContext> {
        // Always use a TrustManager that accepts all certificates (including expired/invalid ones)
        ...
        return Optional.of(createTrustAllSslContext())
    }
    ...
    companion object {
        ...
        private val logger = LoggerFactory.getLogger(HttpCheckerClientConfiguration::class.java)
    }
}
